...
//
// src/data/tiles.ts'in KOPYASI — bkz. types.ts'teki not. Yalnızca puan
// tablosu (letterPoints) kullanılıyor; dağılım (cnt) sunucu tarafında
// init_online_game_state RPC'sinde ayrıca (bu dosyadan bağımsız) tutuluyor.
