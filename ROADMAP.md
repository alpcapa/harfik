...
| **1.0.6'ya binen kod** | Biten Canlı oyunun haberi (`OYUN BİTTİ`/`TESLİM OLDUN` + `YENİ` rozeti + sekme sayacı) · skor kartında kafa kafaya oran çubuğu · `Tüm Oyunlar` etiketinin tekleşmesi | ⏳ **kod TAMAM, sürüm 1.0.6'ya çıkarıldı; `.aab` GÖNDERİLMEDİ** — kullanıcı kuralı: önce APK cihazda onaylanacak (3 Eylül 2026, kullanıcı: *"Apk'yı test edeyim, sonra aab'yi yarın atarım"*). Kanonik paket kütüğü: `mobile/docs/build-and-distribution-log.md` |
