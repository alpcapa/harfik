# Parça Günlüğü — Parça 110-138 (DONDURULMUŞ)

> **Bu cilt kapalı.** 26 Ağustos 2026'da `mobile/docs/parca-log.md` 151 KB'a
> çıkıp uyarı bandına girdiği için bölündü (kök `CLAUDE.md` → "Doküman
> Boyutu Bütçesi": *"active → yeni bir cilt aç: dosyayı bir bölüm/parça
> sınırından kes, dondurulmuş yarıyı betikteki FROZEN listesine ekle"*).
> Hiçbir satır değiştirilmedi, yalnızca taşındı.
>
> **Buraya YENİ GİRİŞ YAZILMAZ** — `check-doc-size` bunu yakalar. Yeni
> girişler aktif cilde: `mobile/docs/parca-log.md`.
>
> **Ciltler:** Parça 1-48 → `parca-log-1-48.md` · 49-109 →
> `parca-log-49-109.md` · **110-138 → bu dosya** · 139+ →
> `parca-log.md` (aktif).
>
> ⚠ Bir atıf ararken cildi baştan sona OKUMA, `grep` ile ara. Ciltler tam
> bu yüzden var.
>
> Not: bu cildin içindeki girişler tam sayı sırasında DEĞİL (dosya
> baştan beri "en yeni en üstte" düzeniyle büyüdü ve arada bazı girişler
> sonradan eklendi). Bölme sırasında sıra KORUNDU, düzeltilmedi —
> yeniden sıralamak diff'i okunmaz hâle getirirdi.
