                  ...
                  <div className="flex justify-between text-[9px] font-mono text-muted mt-0.5">
                    <span className="flex flex-col items-start leading-tight">
                      ...
                      {rankDown.newTier.reward > 0 && (
                        <span className="text-green font-bold">(+{rankDown.newTier.reward})<span className="text-[13px] leading-none align-middle">✓</span></span>
                      )}
                    </span>
                    ...
                    <span className="flex flex-col items-end leading-tight">
                      ...
                      <span className="text-green font-bold">
                        (+{tierFor(rankDown.fromThreshold).reward})<span className="text-[13px] leading-none align-middle">✓</span>
                      </span>
                    </span>
                  </div>
                </div>
